...
namespace XperienceAdapter.Repositories
{
	...
	Action<MultiDocumentQuery>? filter = default)
        ...
        public Task<IEnumerable<TPageDto>> GetPagesByTypeAndCultureAsync(IEnumerable<string> types, SiteCulture culture, string cacheKey, Action<MultiDocumentQuery>? filter = null, Func<TPage, TPageDto, TPageDto>? additionalMapper = null, bool includeAttachments = false, CancellationToken cancellationToken = default, params string[] cacheDependencies)
        {
            throw new NotImplementedException();
        }
    }
